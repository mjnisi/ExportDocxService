...
//			El según parámetro es el String a insertar en el documento docx con el estilo comentado.
			...
			mlPackage.save(new java.io.File("helloworld7.docx"), Docx4J.FLAG_SAVE_ZIP_FILE);

		} catch (Docx4JException | IOException | ParseException | XPathParseException | XPathEvalException | NavException e) {
			e.printStackTrace();
		}
...
//	        Object templates;
//			InputStream is = getClass().getClassLoader().getResourceAsStream(templates.get(key));
